...
class StudentProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_profile" do
    assert_difference('StudentProfile.count') do
      post student_profiles_url, params: { student_profile: { description: @student_profile.description, subjects: @student_profile.subjects, user_id: @student_profile.user_id, year: @student_profile.year } }
    end
  ...
  test "should update student_profile" do
    patch student_profile_url(@student_profile), params: { student_profile: { description: @student_profile.description, subjects: @student_profile.subjects, user_id: @student_profile.user_id, year: @student_profile.year } }
